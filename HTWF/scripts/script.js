    ...
    */
    ...
    $.fn.initFlexSlider = function () {
        ...
        if ($(obj).hasClass("carousel")) {
            ...
            if ($(window).width() < 768) { // or < 993 for tablets
                numItems = 1;
                itemWidth = ow; // full width
                itemMargin = 0;
            }

            else if ($(window).width() < 1200) { 
            // Tablet
            numItems = 2; // or whatever you prefer
            itemWidth = ow / numItems;
            itemMargin = 10; // you can adjust margins for tablets
    ...
    $(document).ready(function () {
        ...
        //MENU - MOBILE
        // MOBILE MENU WITHOUT toggleClick
        $(function () {
            ...
            $toggleBtn.on("click", function () {
                if ($navbar.is(":visible")) {
                    $navbar.collapseItem();   // theme’s close method
                    $(".subline-bar ul").hide();
                } else {
                    $navbar.expandItem();     // theme’s open method
                }
            });

            // Handle dropdown links (your existing logic)
            ...
            $navbar.on("click", "a:not([data-toggle='dropdown'])", function () {
                if ($navbar.is(":visible")) {
                    $navbar.collapseItem();
                    $(".subline-bar ul").hide();
                }
